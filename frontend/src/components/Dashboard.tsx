...
const RepositoryOverview = dynamic(() => import('./RepositoryOverview'));
const CommitAnalysis = dynamic(() => import('./CommitAnalysis'));
const ContributorsList = dynamic(() => import('./ContributorsList'));
...
const RecentCommitsTable = dynamic(() => import('./RecentCommitsTable'));
const InsightsPanel = dynamic(() => import('./InsightsPanel'));
const CodebaseComposition = dynamic(() => import('./CodebaseComposition'));
