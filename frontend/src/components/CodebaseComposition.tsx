...
export const CodebaseComposition: React.FC<Props> = ({ compositionData, loading }) => {
  ...
  if (!currentNode) {
    return (
      <div className="bg-white dark:bg-bg-card border border-border-card rounded-[12px] p-8 text-center text-text-secondary">
        ...
        <h3 className="text-[14px] font-bold text-text-heading">Codebase Composition Unavailable</h3>
  ...
  // Determine a color gradient tint class based on size percentage
  ...
  return (
    <div className="bg-white dark:bg-bg-card border border-border-card rounded-[12px] p-6 shadow-soft flex flex-col justify-between min-h-[480px]">
      ...
      {children.length === 0 ? (
        ...
        /* Treemap Grid View */
        <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3.5 mb-4 content-start">
          {children.map((child) => {
              ...
              {children.map((child) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className="py-3 px-4 text-center text-text-muted capitalize whitespace-nowrap">
                      {child.type}
                    </td>
                    <td className="py-3 px-4 font-bold text-text-primary whitespace-nowrap">
                      {formatSize(child.size)}
                    ...
                    <td className="py-3 px-4 whitespace-nowrap">
                      <div className="w-24 bg-slate-100 dark:bg-bg-secondary rounded-full h-1.5 overflow-hidden">
                        <div
                    ...
                    <td className="py-3 px-4 text-right font-bold text-text-secondary whitespace-nowrap">
                      {percentage}%
                    </td>
                  </tr>
                );
      ...
      <div className="bg-slate-50 dark:bg-bg-secondary/40 border border-border-divider/50 rounded-xl p-3.5 flex flex-col md:flex-row md:items-center justify-between gap-3 text-[12.5px] text-text-secondary">
